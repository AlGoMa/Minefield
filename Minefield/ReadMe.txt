...
A-F: Each mine starts with a shield that has 100 health.  There is a 20% chance that a shield may begin with double health.
     The shield will regenerate 50 health at the start of its team's turn, up to the initial starting health.  A shield 
     with no health remaining is destroyed.
...
It is preferred that Visual Studio 2019 or later is used as your development environment.  Visual Studio
